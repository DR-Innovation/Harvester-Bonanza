...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php="http://php.net/xsl">
	...
	<xsl:template name="asset">
		<DR xmlns="http://www.danskkulturarv.dk/DKA.DR.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.danskkulturarv.dk/DKA.DR.xsd ../../Base/schemas/DKA.DR.xsd ">
